...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://5t0kr8g0o3.execute-api.us-east-1.amazonaws.com/Test';
    ...
    apigClient.verifyPost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['body'], ['body']);
        
        var verifyPostRequest = {
        ...
        return apiGatewayClient.makeRequest(verifyPostRequest, authType, additionalParams, config.apiKey);
    };
